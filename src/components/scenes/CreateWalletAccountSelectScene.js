        ...
        <View style={styles.selectPaymentLower}>
          ...
          <View style={styles.paymentAndIconArea}>
            <View style={styles.paymentLeftIconWrap}>
              <CurrencyIcon walletId={walletId} sizeRem={1.5} currencyCode={wallet.currencyCode} resizeMode="cover" />
            </View>
            <View style={styles.paymentArea}>
        ...
        <View style={styles.scene}>
          ...
          <ScrollView>
            <View style={styles.scrollableView}>
              <CurrencyIcon walletId={walletId} currencyCode={selectedWalletType.currencyCode} sizeRem={4} marginRem={[1.5, 0, 0, 0]} />
